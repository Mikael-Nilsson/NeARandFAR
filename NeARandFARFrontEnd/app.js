...
const app = new Vue({
    ...
    methods: {
        startSession: function () {
            //this.shared.log('Starting session, lat: ', globalState.position.latitude, this.private.loaded);
        ...
        getAssets: async function () {
            ...
            //    this.shared.log('conversation collected', conversation);
            ...
            this.shared.log('data collected', this.shared.objectArray);
        },

        compass: function () {
            this.shared.log('adding compass at ', this.shared.position.latitude, this.shared.position.longitude);
            return [
                {
                    geometry: 'text',
                    scale: '20 20 20',
